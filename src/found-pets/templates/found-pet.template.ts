...
export const generateFoundPetEmailTemplate = (
  ...
  const imageUrl = generateMapBoxStaticImage(foundPet.latitude, foundPet.longitude);
  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <h3 style="color: #2c3e50;">📍 Ubicación donde fue encontrada:</h3>
      <img 
        src="${imageUrl}" 
        alt="Mapa de ubicación" 
        style="width: 100%; border-radius: 8px; margin-bottom: 12px;" 
      />
      <p><b>Dirección:</b> ${foundPet.address}</p>
